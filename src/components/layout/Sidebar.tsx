...
const NAV_ITEMS: NavItem[] = [
    ...
    { label: 'Liens stores', href: '/dashboard/store-links', icon: <Smartphone size={20} />, module: 'pricing' },
    { label: 'Accès gratuit', href: '/dashboard/comp-access', icon: <Gift size={20} />, module: 'pricing' },
